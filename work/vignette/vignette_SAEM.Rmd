...
ng <- 12 #nombre d'individu par groupe
G <- 4 # nombre groupe
#===============================#
...
S <- get_stat(function(eta, phi) mean((Y - get_obs(m, dt, eta = eta, phi = phi) )^2 ),
...
data.frame( Oracle = maxi(S(attr(dt, 'eta'), attr(dt, 'phi') )) %>% unlist ,
