...
param <- list(rho2 = 0.1,
              sigma2 = 0.05,
              mu = c(4,1), #sample(1:5, size = F.),#c(5,4,0.5),
              omega2 = c(0.4, 0.1) ) #sample(seq(0.3,0.6, length.out = 10 ), F.) ) #c(0.5,0.1,0.01))
#=======================================#
...
res <- SAEM(niter, 1, u, para, Phi, S, Z, sim, maxi, eps = 1e-3, verbatim = T)
```
