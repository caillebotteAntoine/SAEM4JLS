...
# --- longitudinal data --- #
G = 8 ; ng = 20 #nombre de groupe et d'individu par groupe
...
#optimisation selon la variance a

require(tictoc)
tic()
res <- optimize(f, c(.01,.04), tol = 1e-2,  a = 0.021, b = 0.025)#, c = 0.025)
toc()

res

Z <- MH_High_Dim_para_future(250, phi,   sd = c( .021, .025, .025), loglik.phi, eta, Phih, cores = 10, verbatim = T)
