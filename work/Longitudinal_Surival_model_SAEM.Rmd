...
# --- longitudinal data --- #
G = 8 ; ng = 12 #nombre de groupe et d'individu par groupe
...
sd.phi <- function(k) ifelse(k<correction.phase, 1, 0.05 )
...
```{r saem plot, echo = F }
gg$plot_paramater# %>% vline(correction.phase, 'purple') %>% vline(2*correction.phase, 'orange') 
